...
motor outtakeLeft = motor(PORT1, ratio36_1, true);
motor outtakeRight = motor(PORT11, ratio36_1, false);
...
led matchLoader = led(Brain.ThreeWirePort.G);
led extendo = led(Brain.ThreeWirePort.H);
